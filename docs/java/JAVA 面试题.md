...
## 一 为什么 Java 中只有值传递 (method)？ passed by reference or by value
...
![example 1 ](JAVA 面试题.assets/1-20201202174409393)
...
![img](JAVA 面试题.assets/1-20201202174409602)
...
![Java程序运行过程](JAVA 面试题.assets/1-20201202174409609)
...
![img](JAVA 面试题.assets/1-20201202174410015)
...
![进程示例图片-Windows](JAVA 面试题.assets/1-20201202174409388)
...
![线程死锁示意图 ](data:image/svg+xml;utf8,<?xml version="1.0"?><svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="351" height="214"></svg>)
